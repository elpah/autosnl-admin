...
import AddDealerForm from "../add-dealer-form/AddDealerForm";
import AddAdvancedInfo from "../add-advanced-info/AddAdvancedInfo";
import AddBasicInfo from "../add-basic-info/AddBasicInfo";
import {
  GlobalContext,
  ICarData,
  type Lang,
      ...
      {carPagePreview === "addCar" && (
        <div className={styles.wrapper}>
          ...
          <div className={styles.info_heads}>
            ...
            <div
              className={`${styles.icon_name} ${
                globalContext.currentSelection === "Advanced"
                  ? styles.active
                  : ""
              }`}
          ...
          <section className={styles.form_section}>
            <AddCarForm>
              {globalContext.currentSelection === "Basic" && (
                <AddBasicInfo
                  {...basicInfoTags[globalContext.currentLanguage]}
                />
              )}
