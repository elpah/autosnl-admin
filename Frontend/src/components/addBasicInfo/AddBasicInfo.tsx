...
import DamageDetailForm from "../DamageDetailsForm/DamageDetailsForm";
    ...
    <div className={styles.container}>
      ...
      <div className={`${styles.form_field} ${styles.vanish}`}>
        ...
        <select
          ...
          onChange={(e) => {
            const selectedVanish = Object.keys(vanish).find((key) => {
              return (
                vanish[key][globalContext.currentLanguage] === e.target.value
              );
            });

            if (selectedVanish) {
              const translations = vanish[selectedVanish];
              updateTranslationFieldFunctionBrandModel(
                "carVanish",
                translations?.en || "",
                translations?.nl || "",
        ...
        >
          ...
          {Object.keys(vanish).map((vanishKey, index) => {
            const vanishName = vanish[vanishKey][globalContext.currentLanguage];
            return (
