  ...
  return (
    <div className={`${styles.form_field} ${styles.dealer}`}>
      ...
      <select
        name="dealer"
        id="dealer"
        value={globalContext.carData.dealer.dealerId}
      ...
      {globalContext.carData.dealer.isOther && (
        <div>
          <input
            value={globalContext.carData.dealer.dealerName}
            onChange={(e) => updateDealerField("dealerName", e.target.value)}
            type="text"
            placeholder="Dealer Name"
          />
          <input
            value={globalContext.carData.dealer.dealerEmail}
            onChange={(e) => updateDealerField("dealerEmail", e.target.value)}
            type="text"
            placeholder="Dealer Email"
          />
          <input
            value={globalContext.carData.dealer.dealerPhone}
            onChange={(e) => updateDealerField("dealerPhone", e.target.value)}
            type="text"
            placeholder="Dealer Phone Number"
          />
          <input
            value={globalContext.carData.dealer.dealerAddress}
            onChange={(e) => updateDealerField("dealerAddress", e.target.value)}
            type="text"
