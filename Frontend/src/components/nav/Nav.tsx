...
const Nav = () => {
  ...
  const [_isWide, setIsWide] = useState(window.innerWidth >= 1024);
  ...
  const handleNavItemClick = (link: string) => {
    setNavIsOpen(false);
    if (globalContext.currentAction !== null) {
      globalContext.setPendingLink(link);
      globalContext.setShowModal(true);
    } else {
      navigate(`/${link}`);
    }
  };
      ...
      >
        ...
        <ul className={styles.ul_container}>
          ...
          <li
            ...
            onClick={() => {
              handleNavItemClick(`cars/available`);
            }}
          >
            <svg
              width="24"
          ...
          <li
            className={
              globalContext.activeMenu === "add-car" ? styles.active : ""
            }
            onClick={() => {
              handleNavItemClick("add-car");
            }}
          >
            <svg
              width="24"
