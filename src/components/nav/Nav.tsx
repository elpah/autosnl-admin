    ...
    <header>
      ...
      >
        ...
        <ul className={styles.ul_container}>
          ...
          >
            <svg
              ...
              className={`${styles.icon} ${
                activeMenu === "dashboard" ? styles.active_icon : ""
              }`}
            >
              <path
          ...
          <li
            className={activeMenu === "cars" ? styles.active : ""}
            onClick={() => {
              setActiveMenu("cars");
              setNavIsOpen(false);
            }}
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              className={`${styles.icon} ${
                activeMenu === "cars" ? styles.active_icon_others : ""
              }`}
            >
              <path
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              className={`${styles.icon} ${
                activeMenu === "settings" ? styles.active_icon : ""
              }`}
            >
              <path
          ...
          <li
            className={activeMenu === "sign out" ? styles.active : ""}
            onClick={() => {
              setActiveMenu("sign out");
              setNavIsOpen(false);
            }}
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              className={`${styles.icon} ${
                activeMenu === "sign out" ? styles.active_icon : ""
              }`}
            >
              <path
