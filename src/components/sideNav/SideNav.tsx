  ...
  return (
    <div className={styles.nav_container}>
      ...
      <div className={styles.ul_container}>
        <ul>
          <li
            className={globalContext.activeMenu === "dashboard" ? styles.active : ""}
            onClick={() => {
          ...
          >
            <svg
              ...
              className={`${styles.icon} ${
                globalContext.activeMenu === "dashboard" ? styles.active_icon : ""
              }`}
            >
              <path
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              className={`${styles.icon} ${
                globalContext.activeMenu === "cars" ? styles.active_icon_others : ""
              }`}
            >
              <path
          ...
          <li
            className={globalContext.activeMenu === "settings" ? styles.active : ""}
            onClick={() => {
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              className={`${styles.icon} ${
                globalContext.activeMenu === "settings" ? styles.active_icon : ""
              }`}
            >
              <path
        ...
        <div
          className={globalContext.activeMenu === "sign out" ? styles.active : ""}
          onClick={() => {
        ...
        >
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            className={`${styles.icon} ${
              globalContext.activeMenu === "sign out" ? styles.active_icon : ""
            }`}
          >
            <path
          ...
          <p className={globalContext.activeMenu === "sign out" ? styles.active : ""}>
            Signout
          </p>
        </div>
      </div>
